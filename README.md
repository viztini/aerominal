...
> [!IMPORTANT]
> **PowerShell and WSL is not supported.**
>
> **Aerominal is incompatible with PowerShell and WSL**, commands will break and the prompt UI does not function correctly.
>
